...
const objectColor = "#A7C7E7"

export function Model(props) {
    const group = useRef();
    const { nodes, materials } = useGLTF('https://utfs.io/f/LKZsvLfoQfF7EUUIB3j6VsPruGgoARk41heb2U0YxnCaOLcB')
    useFrame(() => {
    ...
    return (
        <group ref={group} {...props} dispose={null} scale={[150, 150, 150]} rotation={[-Math.PI/2, 0, 0]}>
            <mesh
                castShadow
                receiveShadow
