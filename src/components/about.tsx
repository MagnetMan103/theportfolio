            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:gap-12">
                    <div className="lg:w-1/2">
                        <p className="text-xl">
                            I&#39;m a 3rd year student pursuing a B.S. in mechanical
                        ...
                        <p className="text-xl mt-4">
                            ...
                            I enjoy playing chess, reading, hiking, and golfing.
                        </p>
                    </div>
                    <div className="flex w-full lg:w-1/2 mt-8 lg:mt-0 items-center justify-center">
