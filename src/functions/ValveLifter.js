...
export function Model(props) {
    const group = useRef();
    const { nodes, materials } = useGLTF('https://utfs.io/f/LKZsvLfoQfF77mQNkRBHTWeIQnviDRAKqh4rEw1L3BH0s6UV')
    useFrame(() => {
    ...
    return (
        <group ref={group} {...props} dispose={null} scale={[800, 800, 800]} rotation={[0, 0, 0]}>
            <mesh
                castShadow
                receiveShadow
